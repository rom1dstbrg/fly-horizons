    ...
    <div className="bg-orange-50 border border-orange-200 rounded-xl p-3.5 space-y-2.5">
      ...
      <div className="flex items-center gap-2">
        ...
        <a
          ...
          className="shrink-0 flex items-center gap-1 px-2.5 py-1.5 rounded-lg bg-white border border-orange-200 text-xs text-orange-700 hover:bg-orange-100 transition-colors"
