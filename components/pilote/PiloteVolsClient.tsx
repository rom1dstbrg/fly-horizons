          ...
          <table className="w-full">
            ...
            <tbody>
              {rows.map((r) => {
                ...
                const isAnnonce = r.type_resa === "annonce_pilote";
                return (
                  <tr
                    key={r.id}
                    role="button"
                    ...
                    className="border-b border-border last:border-0 hover:bg-secondary/20 transition-colors cursor-pointer focus:outline-none focus-visible:ring-2 focus-visible:ring-navy/30 focus-visible:ring-inset"
                  >
                    ...
                    <td className="px-4 py-3">
                      <span className="font-semibold text-foreground text-sm whitespace-nowrap inline-flex items-center gap-1.5">
