...
add(
  ...
  et.volSurMesureQuoteEmail({
    ...
    distKm: 142,
    waypoints: [
      { lat: 50.6674, lng: 4.5681, nom: "Ottignies" },
      { lat: 50.4673, lng: 4.8674, nom: "Namur" },
      { lat: 50.2590, lng: 4.9120, nom: "Dinant" },
      { lat: 50.3553, lng: 4.6579, nom: "Fosses-la-Ville" },
    ],
...
add(
  ...
  et.volSurMesureQuoteEmail({
    ...
    waypoints: [
      { lat: 50.4673, lng: 4.8674, nom: "Namur" },
      { lat: 50.6451, lng: 5.5722, nom: "Liège" },
      { lat: 50.2590, lng: 4.9120, nom: "Dinant" },
    ],
