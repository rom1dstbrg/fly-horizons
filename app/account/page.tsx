...
import { Package, Ticket, MapPin, ShoppingBag } from "lucide-react";
        ...
        <div className="grid grid-cols-3 gap-4">
          <div className="card-premium p-4 text-center">
            ...
            <p className="text-xs text-muted-foreground mt-1">
              Commande{(orders?.length ?? 0) !== 1 ? "s" : ""}
            </p>
          </div>
          <div className="card-premium p-4 text-center">
            <p className={`text-2xl font-bold ${activeVouchers.length > 0 ? "text-primary" : "text-foreground"}`}>
              {activeVouchers.length}
            </p>
            <p className="text-xs text-muted-foreground mt-1">
              Voucher{activeVouchers.length !== 1 ? "s" : ""} actif{activeVouchers.length !== 1 ? "s" : ""}
            </p>
          </div>
          <div className="card-premium p-4 text-center">
