...
import { ShieldCheck, PlaneTakeoff, Users, FileCheck } from "lucide-react";
    ...
    <main className="min-h-screen bg-[#f5f5f7]">
      ...
      <section className="pt-[98px] pb-24 sm:pb-32">
        <div className="max-w-[1400px] mx-auto px-4 sm:px-6 xl:px-10 pt-2 sm:pt-12">
          ...
          {/* ── Grille : étapes + légal gauche · formulaire droite ── */}
          <div className="grid lg:grid-cols-[1fr_460px] gap-6 lg:gap-10 items-start">
            ...
            {/* Formulaire */}
            <div className="bg-card border border-border rounded-lg p-8 sm:p-10 shadow-premium-lg lg:sticky lg:top-28">
              <h2 className="text-2xl font-black text-foreground mb-1">Faire une demande</h2>
