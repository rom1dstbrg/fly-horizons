// Charte pilote acceptée au premier accès à l'espace (Bloc A · item 6).
// Rédigée en interne, sans avis d'avocat (voir questionnaire Q83). La preuve
// d'acceptation est conservée sur la fiche pilote : conditions_accepted_at +
// conditions_version.
//
...
export const CHARTE_PILOTE_TEXTE = `Fly Horizons met en relation des passagers et des pilotes pour des vols en partage de frais. Fly Horizons n'est pas l'exploitant de ces vols et n'assure aucune fonction de transporteur aérien. En rejoignant l'espace pilote, vous acceptez les points suivants.

1. Responsabilité du vol
...
4. Appareil et assurance
Vous n'utilisez que des appareils pour lesquels vous êtes autorisé et assuré. Vous vous assurez que l'assurance couvrant les passagers est en vigueur pour le vol, dans les mêmes conditions que pour vos vols habituels.

5. Paiement
Le paiement du passager se règle directement avec vous, en dehors de Fly Horizons. Fly Horizons ne perçoit aucune commission et n'intervient à aucun moment dans l'encaissement. En cas d'annulation, le remboursement éventuel est de votre ressort puisque vous avez perçu la somme.

6. Relation avec le passager
Vous contactez le passager, convenez du créneau, transmettez les informations pratiques et l'accueillez le jour du vol. Vous restez courtois, ponctuel et transparent sur le déroulement. Les échanges passent par les outils fournis dans l'espace pilote.
